...
const SecondSideBar = ({ isSecondOpen, setIsSecondOpen }) => {
  useEffect(() => {
  ...
  return (
    <div
      className={`font-roboto fixed left-0 top-0 z-10 h-full w-[230px] flex-shrink-0 transform flex-col items-center overflow-auto bg-white pt-[11.5px] ${isSecondOpen ? "translate-x-0" : "-translate-x-full"} flex transition duration-200 ease-linear`}
    >
      ...
      <div className="font-roboto inline-flex h-[40px] w-[200px] items-center gap-[5px] rounded-lg pl-[10.5px] text-[15px] font-medium hover:bg-[hsl(0,0%,90%)]">
        <h1>You</h1>
        <RightArrow color="black" size={20} />
      </div>
      <div className={sectionStyles}>
